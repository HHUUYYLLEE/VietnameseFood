    ...
    <div class="review-wrapper">
        <div class="container">
            <div class="d-flex justify-content-between mb-4">
                <button class="btn btn-light border px-5 filter-by-star" data-star="5"
                        style="background-color: #FDFFFB;">5
                    <i class="fa-solid fa-star" style="color: #CEC71C"></i>
                    (
                    {!! $star[5] !!}
                    )
                </button>
                <button class="btn btn-light border px-5 filter-by-star" data-star="4"
                        style="background-color: #FDFFFB;">4
                    <i class="fa-solid fa-star" style="color: #CEC71C"></i>
                    (
                    {!! $star[4] !!}
                    )
                </button>
                <button class="btn btn-light border px-5 filter-by-star" data-star="3"
                        style="background-color: #FDFFFB;">3
                    <i class="fa-solid fa-star" style="color: #CEC71C"></i>
                    (
                    {!! $star[3] !!}
                    )
                </button>
                <button class="btn btn-light border px-5 filter-by-star" data-star="2"
                        style="background-color: #FDFFFB;">2
                    <i class="fa-solid fa-star" style="color: #CEC71C"></i>
                    (
                    {!! $star[2] !!}
                    )
                </button>
                <button class="btn btn-light border px-5 filter-by-star" data-star="1"
                        style="background-color: #FDFFFB;">1
                    <i class="fa-solid fa-star" style="color: #CEC71C"></i>
                    (
                    {!! $star[1] !!}
                    )
            ...
            <div class="dropdown mb-5">
                <button style="background-color: #FDFFFB;" class="btn btn-light border dropdown-toggle px-5"
