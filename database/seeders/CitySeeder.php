...
class CitySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('citys')->insert([
            ['content' => 'Ha Noi', 'updated_at' => now(), 'created_at' => now()],
            ['content' => 'Ho Chi Minh', 'updated_at' => now(), 'created_at' => now()],
            ['content' => 'Da Nang', 'updated_at' => now(), 'created_at' => now()],
            ['content' => 'Nha Trang', 'updated_at' => now(), 'created_at' => now()],
